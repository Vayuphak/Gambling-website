...
<body>
    ...
    <div class="container">
        ...
        <?php if (isset($_SESSION['withdraw_error']) || isset($_SESSION['withdraw_success'])) {
    echo '<div class="alert-container">';
    
    // Display error message if available
    if (isset($_SESSION['withdraw_error'])) {
        echo '<div class="alert error">'.$_SESSION['withdraw_error'].'</div>';
        unset($_SESSION['withdraw_error']);
    }
    
    // Display success message if available
    if (isset($_SESSION['withdraw_success'])) {
        echo '<div class="alert success">'.$_SESSION['withdraw_success'].'</div>';
...
?> 
        <form id="withdrawForm" action="withdrawdb.php" method="POST" onsubmit="return validateForm()">
...
>
            ...
            <button type="submit" name="subwithdraw">Withdraw Now</button>
        </form>
    </div>
